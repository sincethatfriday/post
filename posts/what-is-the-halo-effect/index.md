...
faq:
  ...
  - question: "What is the opposite of the halo effect?"
    answer: "The opposite is called the horn effect, where one negative impression makes us assume everything else about a person, brand, or product is also bad. A single rude reply on Instagram or one broken page on a website can quietly create a horn effect that colours how people perceive everything else you do."
  - question: "Who discovered the halo effect?"
    answer: "The halo effect was discovered by American psychologist Edward Thorndike in 1920. He noticed that army officers were rating their soldiers either uniformly high or uniformly low across unrelated traits like discipline, intelligence, and physical fitness — meaning one strong impression was bleeding into how every other trait was judged."
  - question: "How does the halo effect influence buying decisions?"
    answer: "The halo effect influences buying decisions by letting one strong signal — like a beautiful website, a premium price, or a memorable logo — shape how people feel about a product before they've even tried it. This is why brand presentation matters as much as product quality, especially for first-time buyers who have nothing else to go on."
  - question: "Can the halo effect be used in branding intentionally?"
    answer: "Yes, brands intentionally use the halo effect by investing heavily in one or two hero touchpoints — usually a flagship product, a website, or a brand voice — and letting that strong impression shape perception across everything else they do. Apple, Tata, and Zomato are all examples of brands using this approach in different ways."
  - question: "Is the halo effect the same as confirmation bias?"
    answer: "No, the halo effect and confirmation bias are different. The halo effect is about one trait influencing our judgment of other unrelated traits. Confirmation bias is about seeking out information that confirms what we already believe. They can overlap, but they describe different mental shortcuts."
---
...
![Horn Effect](images/horn-effect.jpeg "The reverse halo is just as quiet, and just as powerful.")
